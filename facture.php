    ...
    <div class="container cc" >
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <center><h2>Facture <small>N°'.$idj.'</small><h2> </center>
          <br>
        </div>
      </div>
      ';
      if($data["idc"] !=""){
        ...
        <div class="row">
            <div class="col-sm-6">
		        <label>Nom de Client:</label> '.$journal->getClient($data['idc'])["nom"]." ".$journal->getClient($data['idc'])["prenom"].'
            </div>
        </div>
        ';
 }
            ...
            <tr>
              ...
              ';
                if($data["tva"] == '1'){
                    ...
                    $tva = floatval($data["tva"]) * $ht;//oum li bch nzidouuh 
