	...
	<body>
      ...
      echo '
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Ajouter Produit</h1>
				</div>
			</div><!--/.row-->
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form  name = "f1" class="form-horizontal row-border" method="POST" action="api/POSTS/produit.php?ajout">
										<div class="form-group">
											<label class="col-md-2 control-label">Nom de Produit:</label>
											<div class="col-md-10">
												<input type="text" name="label" class="form-control" placeholder="Nom de Produit" required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Nom de Fournisseur:</label>
												<div class="col-md-4">
													<select name="idf" class="form-control input-sm">
													';
														$fornisseur->getFornisseurSelectList();

													echo '</select>
												</div>
												<div class="col-md-4">
												<a href="ajoutFornisseur.php" class="fa fa-plus btn btn-sm btn-default" > Ajouter Fournisseur</a>
												</div>
										</div>
										<div class="form-group">
											<label class="col-md-2 control-label">Prix de Vente:</label>
											<div class="col-md-10">
												<input class="form-control" type="text" name="prix_vente"  placeholder="Prix de Vente en DT" required>
											</div>
										</div>
										<div class="form-group col-md-20 ">
											<div class="col-md-10">
												<button  class="btn btn-lg btn-primary  " type="reset"><span class="fa fa-times"></span> &nbsp;Annuler</button>
													<button  class="btn btn-lg btn-primary "  onclick="return verif()" type="submit"><span class="fa fa-user-plus"></span> &nbsp;Ajouter Porduit</button>
														</div>
													</div>
												</div>
											</form>
