...
if(!$admin->checkLogin()){
						...
						<div class="col-md-12">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form class="form-horizontal row-border" name="form1" action="api/POSTS/devis.php" method="POST">
										<div class="form-group">
											...
											<div class="col-md-2 " >
												<input class="input-sm" type="number" name="qte" class="form-control" value="1" placeholder="Quantite de Produit" required>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-2">
												<input class="input-sm"type="text" name="idc" class="form-control" placeholder="nom du client">
											</div>
										</div>
										<div class="form-group col-md-20 ">
											<div class="col-md-10">
												<button  class="btn btn-ls btn-primary  " type="reset"><span class="fa fa-times"></span> &nbsp;Annuler</button>
													<button  class="btn btn-ls btn-primary  " onclick="return verif()" type="submit"><span class="fa fa-cart-plus"></span>Imprimer devis</button>
    ...
    <script src="style/js/clock.js"></script>
	  <script src="style/js/devis.js"></script>
	</body>
</html>
    ';
}
