...
if(!$admin->checkLogin()){
    ...
    $client = new Client();
    file_put_contents("JSON/client.json",json_encode($client->liste()));
        ...
        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <table data-toggle="table" id="table" data-url="JSON/client.json" data-show-export="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="reste" data-sort-order="desc">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ddp" data-sortable="true">Dernier Date Payment</th>
                                                <th data-field="reste" data-sortable="true">Reste totale</th>
