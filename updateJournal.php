...
if(!$admin->checkLogin()){
    ...
    if($idc != ""){
        ...
        $client   = new Client();
        $detaillesClients = $client->showData($idc);
    }
    ...
    <html>
        <head>
            ...
            <title>Mettre a jours Journal </title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Mettre a jour - Journal </li>
				</ol>
			</div><!--/.row-->

			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Mettre a jour - Journal </h1>
				</div>
			</div><!--/.row-->
            <div class="row">
                <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          <form name="f1" action="api/POSTS/journal.php?update" method="POST">
          <input type="text" name="idjournal" value="'.$idj.'" hidden>
